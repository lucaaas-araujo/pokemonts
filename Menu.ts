...
//                 if(tipo == 1){
//                     let p = new Agua(id, nome, "Agua", geracao);
//                     controller.cadastrar(p);

//                 }else if(tipo == 2){
//                     let p = new Eletrico(id, nome, "Eletrico", geracao);
//                     controller.cadastrar(p);

//                 }else if(tipo == 3){
//                     let p = new Fogo(id, nome, "Fogo", geracao);
//                     controller.cadastrar(p);

//                 }else if(tipo == 4){
//                     let p = new Grama(id, nome, "Grama", geracao);
//                     controller.cadastrar(p);
...
//                 let atualizado = new Agua(idAtualizar, nomeAtualizar, "Agua", geracaoAtualizar);
